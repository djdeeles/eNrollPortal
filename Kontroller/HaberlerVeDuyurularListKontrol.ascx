<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HaberlerVeDuyurularListKontrol.ascx.cs"
            Inherits="EnrollPortal.Kontroller.HaberlerVeDuyurularListKontrol" %>
