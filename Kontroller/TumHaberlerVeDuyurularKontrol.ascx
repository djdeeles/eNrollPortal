<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TumHaberlerVeDuyurularKontrol.ascx.cs"
            Inherits="EnrollPortal.Kontroller.TumHaberlerVeDuyurularKontrol" %>
...
<div class="kategori">
    <div class="modulkategori">
        ...
        <div class="moduldetayicerik">
            <div class="moduldetayicerik2">
                <asp:Menu ID="MenuHaberKategoriler" runat="server" Orientation="Vertical" StaticSubMenuIndent=""
