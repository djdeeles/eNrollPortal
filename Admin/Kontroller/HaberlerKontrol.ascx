<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HaberlerKontrol.ascx.cs"
            Inherits="EnrollPortal.Admin.Kontroller.HaberlerKontrol" %>
                        ...
                        <td>
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadDateTimePicker ID="RadDateTimePickerKayitTarihi" runat="server" Culture="tr-TR">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="RadDateTimePickerKayitTarihi"
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DuzenlenmeTarihi" HeaderText="Düzenlenme Tarihi" SortExpression="DuzenlenmeTarihi">
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:BoundField>
