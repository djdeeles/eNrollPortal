<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FotoAlbumKategorileriKontrol.ascx.cs"
            Inherits="EnrollPortal.Admin.Kontroller.FotoAlbumKategorileriKontrol" %>
                    ...
                    <tr>
                        <td>
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    <td style="width: 100px;">
                                        Personel Kategorisi Mi?
                                    </td>
                                    <td style="width: 10px;">
                                        :
                                    </td>
                                    <td style="width: 200px;">
                                        <asp:CheckBox ID="CheckBoxPersonelKategorisiMi" runat="server" Text="Evet" />
                                    </td>
                                    <td style="width: 390px;">
                                    </td>
                                </tr>
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:CheckBoxField DataField="PersonelKategorisiMi" HeaderText="Personel Kategorisi Mi"
                                                           SortExpression="PersonelKategorisiMi">
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollPortalEntities"
                                                      DefaultContainerName="EnrollPortalEntities" EnableFlattening="False" EntitySetName="FotoAlbumKategorileri"
