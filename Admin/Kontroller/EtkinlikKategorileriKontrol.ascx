<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EtkinlikKategorileriKontrol.ascx.cs"
            Inherits="EnrollPortal.Admin.Kontroller.EtkinlikKategorileriKontrol" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollPortalEntities"
                                                      DefaultContainerName="EnrollPortalEntities" EnableFlattening="False" EntitySetName="EtkinlikKategorileri"
