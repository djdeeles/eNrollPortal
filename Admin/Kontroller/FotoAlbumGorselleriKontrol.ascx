<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FotoAlbumGorselleriKontrol.ascx.cs"
            Inherits="EnrollPortal.Admin.Kontroller.FotoAlbumGorselleriKontrol" %>
                        ...
                        <td>
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:DropDownList ID="DropDownListFotoAlbumKategorileri" runat="server" Width="200px"
                                                          AutoPostBack="True" OnSelectedIndexChanged="DropDownListFotoAlbumKategorileri_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:DropDownList ID="DropDownListAlbumler" runat="server" Width="200px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="DropDownListAlbumler"
                                                                    Display="Dynamic" ErrorMessage="Gerekli." ForeColor="Red" InitialValue="0" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxGorselAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxGorselAdi"
                                    ...
                                    <td style="width: 200px;" colspan="2">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBoxGorsel"
                                                                                Display="Dynamic" ErrorMessage="Gerekli." ForeColor="Red" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                        </table>
                ...
                <td>
                    <table class="AnaTablo">
                        <tr>
                            <td style="text-align: right; width: 700px;">
                                ...
                                <asp:DropDownList ID="DropDownListFotoAlbumKategorileriGridView" runat="server" AutoPostBack="True"
                                                  OnSelectedIndexChanged="DropDownListFotoAlbumKategorileriGridView_SelectedIndexChanged"
                                                  Width="250px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right; width: 700px;">
                                Albüm :
                                <asp:DropDownList ID="DropDownListAlbumlerGridView" runat="server" OnSelectedIndexChanged="DropDownListAlbumlerGridView_SelectedIndexChanged"
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="GorselAdi" HeaderText="Görsel Adı" SortExpression="GorselAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
