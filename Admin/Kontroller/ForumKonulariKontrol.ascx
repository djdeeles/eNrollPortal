<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ForumKonulariKontrol.ascx.cs"
            Inherits="EnrollPortal.Admin.Kontroller.ForumKonulariKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:DropDownList ID="DropDownListForumKategorileri" runat="server" Width="200px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DropDownListForumKategorileri"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxBaslik" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxBaslik"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <br />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="RadEditorIcerik"
                                                                    Display="Dynamic" ErrorMessage="Gerekli." ForeColor="Red" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <table class="AnaTablo">
                        <tr>
                            <td style="text-align: right; width: 700px;">
                                Kategori :
                                <asp:DropDownList ID="DropDownListForumKategorileriGridView" runat="server" AutoPostBack="True"
                                                  OnSelectedIndexChanged="DropDownListForumKategorileriGridView_SelectedIndexChanged"
                                                  Width="250px">
                                </asp:DropDownList>
                            </td>
                        </tr>
