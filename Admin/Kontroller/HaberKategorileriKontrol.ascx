<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HaberKategorileriKontrol.ascx.cs"
            Inherits="EnrollPortal.Admin.Kontroller.HaberKategorileriKontrol" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollPortalEntities"
                                                      DefaultContainerName="EnrollPortalEntities" EnableFlattening="False" EntitySetName="HaberKategorileri"
