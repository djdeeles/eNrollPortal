<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RollerKontrol.ascx.cs"
            Inherits="EnrollPortal.Admin.Kontroller.RollerKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="vertical-align: top;">
                                        <asp:CheckBoxList ID="CheckBoxListYetkiAlanlari" runat="server">
                                        </asp:CheckBoxList>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridViewRoller" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                              ...
                                              Width="700px" OnRowCommand="GridViewRoller_RowCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="RolAdi" HeaderText="Rol Adı" SortExpression="RolAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollPortalEntities"
                                                      DefaultContainerName="EnrollPortalEntities" EnableFlattening="False" EntitySetName="Roller"
                                                      Where="">
